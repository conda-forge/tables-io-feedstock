...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tables-io-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13774&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tables-io-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tables-io` can be installed with:

```
conda install tables-io
```

It is possible to list all of the versions of `tables-io` available on your platform with:
